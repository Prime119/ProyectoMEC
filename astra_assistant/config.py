"""
Configuración del asistente Astra + detección de hardware.

Usa llama.cpp (puerto 8080) en vez de Ollama.
Auto-escala el modelo según los recursos disponibles.
"""
...
DEFAULT_CONFIG_PATH = PACKAGE_ROOT / "astra.config.json"
...
def load_config(path: Path | None = None) -> AstraConfig:
    ...
    return AstraConfig(raw=raw, hardware=hardware)
